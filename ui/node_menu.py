...
class NumberMenu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        insertNode(layout, "an_FloatRangeListNode", "Integer Range", {"assignedType" : repr("Integer")})
        insertNode(layout, "an_FloatRangeListNode", "Float Range", {"assignedType" : repr("Float")})
        layout.separator()
