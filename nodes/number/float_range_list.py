...
class FloatRangeListNode(bpy.types.Node, AnimationNode):
    ...
    def getExecutionCode(self):
        if self.dataType == "Float":
            return "list = algorithms.list_creation.createDoubleListRange(amount, start, step)"
        if self.dataType == "Integer":
            return "list = algorithms.list_creation.createLongLongListRange(amount, start, step)"
