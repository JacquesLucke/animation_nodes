...
class FCurveAnimationOffsetTemplate(bpy.types.Operator, Template):
    ...
    def insert(self):
        ...
        additionalOffsetNode.inputs[0].value = [2, 0, 2]
        transformationOffsetNode = self.newNode('an_ComposeMatrixNode', x = 220, y = -325)
        transformationOffsetNode.inputs[0].value = [3, 0, 0]
        ...
        animationOffsetGroupInputNode.newParameter('Matrix', name = 'Transformation Offset')
        ...
        objectLoopInputNode.newParameter('Matrix', name = 'Transformation Offset')
