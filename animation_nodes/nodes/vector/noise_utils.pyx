...
def blFractal(str noiseBasis, Vector3DList vectors, float fractalDimension, float lacunarity, 
    ...
    for i in range(amount):
        v = vectors.data[i]
        values.data[i] = noise.fractal(Vector((v.x, v.y, v.z)), fractalDimension, lacunarity, octaves, 
                                                        noise_basis = noiseBasis)
    return values
...
def blMultiFractal(str noiseBasis, Vector3DList vectors, float fractalDimension, float lacunarity, 
    ...
    for i in range(amount):
        v = vectors.data[i]
        values.data[i] = noise.multi_fractal(Vector((v.x, v.y, v.z)), fractalDimension, lacunarity, octaves,
                                                        noise_basis = noiseBasis)
    return values 
...
def blHeteroTerrain(str noiseBasis, Vector3DList vectors, float fractalDimension, float lacunarity, 
    ...
    for i in range(amount):
        v = vectors.data[i]
        values.data[i] = noise.hetero_terrain(Vector((v.x, v.y, v.z)), fractalDimension, lacunarity, octaves, 
                                                offset, noise_basis = noiseBasis)
    return values  
...
def blRigidMultiFractal(str noiseBasis, Vector3DList vectors, float fractalDimension, float lacunarity, 
    ...
    for i in range(amount):
        v = vectors.data[i]
        values.data[i] = noise.ridged_multi_fractal(Vector((v.x, v.y, v.z)), fractalDimension, lacunarity, octaves, 
                                            offset, gain, noise_basis = noiseBasis)
    return values
...
def blHybridMultiFractal(str noiseBasis, Vector3DList vectors, float fractalDimension, float lacunarity, 
    ...
    for i in range(amount):
        v = vectors.data[i]
        values.data[i] = noise.hybrid_multi_fractal(Vector((v.x, v.y, v.z)), fractalDimension, lacunarity, octaves, 
                                            offset, gain, noise_basis = noiseBasis)
    return values  
