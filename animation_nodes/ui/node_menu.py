...
class GPencilMenu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.separator()
        insertNode(layout, "an_GPLayerBlendModeNode", "Layer Blend Mode")
        insertNode(layout, "an_GPLayerOpacityNode", "Layer Opacity")
        insertNode(layout, "an_GPLayerPassIndexNode", "Layer Pass Index")
        layout.separator()
        insertNode(layout, "an_GPStrokeCyclicNode", "Stroke Cyclic")
        insertNode(layout, "an_GPStrokeLineWidthNode", "Stroke Line Width")
