...
class GPencilMenu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.separator()
        insertNode(layout, "an_GPSetLayerBlendModeNode", "Set Layer Blend Mode")
        ...
        insertNode(layout, "an_GPSetStrokeStartCapModeNode", "Set Stroke Start Cap")
        insertNode(layout, "an_GPSetStrokeEndCapModeNode", "Set Stroke End Cap")
        insertNode(layout, "an_GPSetStrokeMaterialIndexNode", "Set Stroke Material Index")
        insertNode(layout, "an_GPSetStrokeDisplayModeNode", "Set Stroke Display Mode")
