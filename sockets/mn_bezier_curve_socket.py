...
class mn_BezierCurveSocket(mn_BaseSocket, mn_SocketProperties):
    ...
    objectName = StringProperty(default = "", description = "Use the curve from this object", update = nodePropertyChanged)
    useWorldSpace = BoolProperty(default = True, description = "Convert points to world space")
